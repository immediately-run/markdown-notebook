/* Inline Lucide-style icon paths. Kept dependency-free so the same set can be
   used both by the React <Icon> component and inside markdown-generated HTML
   (callout heads, task checkboxes) where we can only emit raw SVG strings.
   Each entry is the inner markup of a 24×24, fill:none, stroke:currentColor svg. */
export const ICON_PATHS: Record<string, string> = {
  ...
  quote: '<path d="M9 7H6a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h2v2a2 2 0 0 1-2 2"/><path d="M20 7h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h2v2a2 2 0 0 1-2 2"/>',
  list: '<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/>',
};

/* Full <svg> string for embedding inside markdown-generated HTML. */
